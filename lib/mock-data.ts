...
export const mockJobSearches = [
  {
    ...
    description:
      "Searching for senior engineering roles at tech companies in San Francisco and surrounding areas",
    jobs: [job1],
  },
  {
    id: "search-2",
    ...
    description:
      "Remote-first companies offering full-stack and backend positions",
    jobs: [job2],
  },
  {
    id: "search-3",
